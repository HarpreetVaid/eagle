    ...
    if protected_access:
        if key is not None and key.strip() != "":
            ...
            if not db_pool.verify_key(key):
                gr.Warning("Invalid Eagle Key. Please check your key or leave empty for limited usage.")
                return {
                    "message": "Invalid Eagle Key. Please obtain a valid Eagle Key by emailing abaranovskis@redsamuraiconsulting.com."
                }, None
            ...
            if file_filepath.lower().endswith('.pdf'):
                try:
                    ...
                    with open(file_filepath, 'rb') as pdf_file:
                        ...
                        if num_pages > 10:
                            gr.Warning(
                                f"With a Eagle Key, PDFs are limited to maximum 10 pages. This document has {num_pages} pages.")
                            # Clean up the temporary file
                            if os.path.exists(file_filepath):
                                os.remove(file_filepath)
                            return {
                                "message": f"PDFs are limited to maximum 10 pages even with a valid Eagle Key. This document has {num_pages} pages. For larger documents, please contact us at abaranovskis@redsamuraiconsulting.com."
                            }, None
                except Exception as e:
            ...
            if key is None:
                ...
                return {
                    "message": "Please obtain a Eagle Key by emailing abaranovskis@redsamuraiconsulting.com. We offer professional consulting and implementation services for local document processing with Eagle, tailored to your organization's needs."
                }, None
                    ...
                    with open(file_filepath, 'rb') as pdf_file:
                        ...
                        if num_pages > 3:
                            ...
                            if os.path.exists(file_filepath):
                                os.remove(file_filepath)
                            return {
                                "message": f"Free tier can only process PDFs with maximum 3 pages. This document has {num_pages} pages. For larger documents, please obtain a Eagle Key by emailing abaranovskis@redsamuraiconsulting.com."
                            }, None
                except Exception as e:
                    print(f"Error checking PDF page count: {str(e)}")
                    # Continue if we can't check the page count, but log the error
...
def summarize_result(json_data, key, client_ip, model_name):
    ...
    Args:
        ...
        key: Eagle key for API authentication
...
with gr.Blocks(theme=gr.themes.Ocean(), css=custom_css) as demo:
            ...
            <div class="custom-navigation" style="background: linear-gradient(135deg, var(--primary-500) 0%, var(--primary-600) 100%); border-radius: 10px;">
                <div style="display: flex; align-items: center; justify-content: space-between; padding: 15px 20px;">
                    <div style="display: flex; align-items: center;">
                        ...
                        <h1 class="nav-title" style="margin: 0; color: white; font-size: 24px; font-weight: 600;">Eagle</h1>
                    </div>
                    ...
                    <div style="margin-top: -10px; padding: 15px; border-left: 4px solid var(--primary-500); border-radius: 6px; background-color: var(--background-fill-secondary);">
                        <div style="display: flex; align-items: flex-start;">
                            ...
                            <div>
                                ...
                                <p style="margin: 5px 0 0 0;">• You can use Eagle without entering a key for limited usage (3 calls per 6 hours, max 3-page documents).</p>
                    ...
                    <div style="margin-top: -10px; padding: 15px; border-left: 4px solid var(--success-500); border-radius: 6px; background-color: var(--success-50);">
                        <div style="display: flex; align-items: flex-start;">
                            ...
                            <div>
                                ...
                                <p style="margin: 5px 0 0 0;">• No Eagle Key required for this deployment.</p>
                            </div>
                        </div>
                    </div>
                    """
    ...
    gr.Markdown(
        ...
        <div style="text-align: center; margin: 25px 0 15px 0; padding: 22px 18px; background: linear-gradient(135deg, rgba(44, 82, 130, 0.08) 0%, rgba(44, 82, 130, 0.12) 100%); border-radius: 10px; border-top: 3px solid var(--primary-500); box-shadow: 0 2px 12px rgba(0, 0, 0, 0.04); border: 1px solid rgba(44, 82, 130, 0.15);">
            ...
            <p style="margin: 8px 0 16px 0; color: #4a5568; font-size: 14px; line-height: 1.5; max-width: 600px; margin-left: auto; margin-right: auto;">Eagle extracts structured data from documents, forms, and images with high accuracy. Process invoices, receipts, bank statements, and tables using on-device Vision LLM models.</p>
            <div style="display: flex; justify-content: center; align-items: center; gap: 15px; flex-wrap: wrap; margin-top: 12px;">
                <span style="font-size: 14px; color: #374151;">
                    Visit <a href="https://katanaml.io/" target="_blank" style="color: #2c5282; text-decoration: none; font-weight: 600; border-bottom: 1px solid transparent; transition: all 0.2s ease;" onmouseover="this.style.borderBottom='1px solid #2c5282'; this.style.color='#1a365d'" onmouseout="this.style.borderBottom='1px solid transparent'; this.style.color='#2c5282'">Katana ML</a> • <a href="https://github.com/katanaml/eagle" target="_blank" style="color: #2c5282; text-decoration: none; font-weight: 600; border-bottom: 1px solid transparent; transition: all 0.2s ease;" onmouseover="this.style.borderBottom='1px solid #2c5282'; this.style.color='#1a365d'" onmouseout="this.style.borderBottom='1px solid transparent'; this.style.color='#2c5282'">Eagle</a> GitHub
                </span>
        ...
        gr.Markdown(
            ...
            <div class="custom-navigation" style="background: linear-gradient(135deg, var(--primary-500) 0%, var(--primary-600) 100%); border-radius: 10px;">
                <div style="display: flex; align-items: center; justify-content: space-between; padding: 15px 20px;">
                    <div style="display: flex; align-items: center;">
                        <span style="font-size: 24px; margin-right: 10px;">🚀</span>
                        <h1 style="margin: 0; color: white; font-size: 24px; font-weight: 600;">Eagle</h1>
                    </div>
