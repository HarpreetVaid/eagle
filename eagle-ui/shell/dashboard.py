...
with gr.Blocks(theme=gr.themes.Ocean()) as demo:
    demo.title = "Eagle Analytics Dashboard"
    ...
    <div id="desktop-message" style="margin-top: -10px; padding: 15px; border-left: 4px solid var(--primary-500); border-radius: 6px; background-color: var(--background-fill-secondary);">
        <div style="display: flex; align-items: flex-start;">
            ...
            <div>
                ...
                <p style="margin: 5px 0 0 0;">This dashboard provides analytics on Eagle usage patterns. View document processing metrics, model usage trends, and geographical distribution of users.</p>
            </div>
        </div>
    </div>
