...
[![PyPI version](https://badge.fury.io/py/eagle-ocr.svg)](https://badge.fury.io/py/eagle-ocr)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)
[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)

Optical Character Recognition (OCR) and text extraction from documents and images. Part of the [Eagle](https://github.com/katanaml/eagle) ecosystem for intelligent document processing.
...
with open("document.png", "rb") as f:
    response = requests.post(
        "http://localhost:8003/api/v1/eagle-ocr/inference",
        files={"file": f}
    )
...
**POST** `/api/v1/eagle-ocr/inference`
...
##### File Upload
```bash
curl -X POST "http://localhost:8003/api/v1/eagle-ocr/inference" \
  -F "file=@document.pdf" \
  -F "include_bbox=true" \
  -F "debug=false"
```
...
## 🤝 Integration with Eagle Components

### With Eagle Parse (Vision LLM)
```python
...
⭐ **Star us on [GitHub](https://github.com/katanaml/eagle)** if you find Eagle OCR useful!
