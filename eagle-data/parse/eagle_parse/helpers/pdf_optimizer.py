...
if __name__ == "__main__":
    ...
    # debug_dir = "/Users/andrejb/infra/shared/katana-git/eagle/eagle-ml/llm/data/"
    # # Ensure the output directory exists
    # os.makedirs(output_directory, exist_ok=True)
    #
    # # Split the optimized PDF into separate pages
    # num_pages, output_files, temp_dir = pdf_optimizer.split_pdf_to_pages("/Users/andrejb/infra/shared/katana-git/eagle/eagle-ml/llm/data/oracle_10k_2014_q1_small.pdf",
    #                                                                      debug_dir,
    #                                                                      True)
    #
