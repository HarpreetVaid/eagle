...
[![PyPI version](https://badge.fury.io/py/eagle-parse.svg)](https://badge.fury.io/py/eagle-parse)
[![Python 3.12+](https://img.shields.io/badge/python-3.12+-blue.svg)](https://www.python.org/downloads/)
[![License: GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)](https://www.gnu.org/licenses/gpl-3.0)

A powerful Python library for parsing and extracting structured information from documents using Vision Language Models (VLMs). Part of the [Eagle](https://github.com/katanaml/eagle) ecosystem for intelligent document processing.
...
```bash
pip install eagle-parse[mlx]
```

To run with Ollama on Linux/Windows:

```
pip install eagle-parse
```
...
```python
from eagle_parse.vlmb.inference_factory import InferenceFactory
from eagle_parse.extractors.vllm_extractor import VLLMExtractor
...
### PDF Processing
```python
from eagle_parse.helpers.pdf_optimizer import PDFOptimizer
...
### Image Optimization
```python
from eagle_parse.helpers.image_optimizer import ImageOptimizer
...
### Table Detection
```python
from eagle_parse.processors.table_structure_processor import TableDetector
...
pip install eagle-parse --no-deps
...
```bash
# Clone repository
git clone https://github.com/katanaml/eagle.git
cd eagle/eagle-data/parse

# Create virtual environment
python -m venv .env_eagle_parse
source .env_eagle_parse/bin/activate  # Linux/Mac
# or
.env_eagle_parse\Scripts\activate  # Windows
...
We welcome contributions! Please see our [Contributing Guidelines](https://github.com/katanaml/eagle/blob/main/CONTRIBUTING.md) for details.

## 📞 Support

- 📖 [Documentation](https://github.com/katanaml/eagle)
- 🐛 [Issue Tracker](https://github.com/katanaml/eagle/issues)
...
⭐ **Star us on [GitHub](https://github.com/katanaml/eagle)** if you find Eagle Parse useful!
