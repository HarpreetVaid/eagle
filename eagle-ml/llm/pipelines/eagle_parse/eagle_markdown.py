...
from pipelines.eagle_parse.eagle_utils import add_page_number
...
def process_markdown_extraction(rag, user_selected_pipeline, query, file_path, hints_file_path, options, crop_size,
    ...
    for i, markdown_output in enumerate(markdown_output_list):
        ...
        rag = get_pipeline("eagle-instructor")
        answer = rag.run_pipeline("eagle-instructor", instruction_query, None, None, options, crop_size,
