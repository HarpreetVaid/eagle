...
def log_inference_start(client_ip, country_name, eagle_key, page_count, model_name,
    ...
    Args:
        ...
        eagle_key (str): Eagle key used for the request
...
def validate_and_increment_key(eagle_key):
    """
    Validates a eagle key and increments its usage counter if valid.

    This function calls the PL/SQL validate_and_increment_key function which:
    1. Checks if the key exists in the EAGLE_KEYS table
    ...
    Args:
        eagle_key (str): The eagle key to validate and increment
