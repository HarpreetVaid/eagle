...
app = FastAPI(
    title="Eagle Agents API",
    description="Eagle multi-agent AI system",
    openapi_url="/api/v1/eagle-agents/openapi.json",
    docs_url="/api/v1/eagle-agents/docs",
    version="1.0.0"
)
...
@app.post("/api/v1/eagle-agents/execute/data", response_model=AgentResponse, tags=["Execution"])
...
@app.post("/api/v1/eagle-agents/execute/data/async", response_model=TaskResponse, tags=["Async Execution"])
...
```
    ...
    After submitting, use the returned task_id with GET /api/v1/eagle-agents/task/{task_id}
    """
    ...
    try:
        ...
        return TaskResponse(
            task_id=task.id,
            status="submitted",
            message=f"Task submitted successfully. Use GET /api/v1/eagle-agents/task/{task.id} to check status."
        )
...
@app.post("/api/v1/eagle-agents/execute/file", response_model=AgentResponse, tags=["Execution"])
async def execute_file_agent(
        agent_name: str = Form(...),
        extraction_params: str = Form(default='{"eagle_key": "12345"}'),
    ...
    - eagle_key: Hex string authentication key
...
@app.post("/api/v1/eagle-agents/execute/file/async", response_model=TaskResponse, tags=["Async Execution"])
...
@app.get("/api/v1/eagle-agents/task/{task_id}", response_model=TaskStatusResponse, tags=["Async Execution"])
...
@app.delete("/api/v1/eagle-agents/task/{task_id}", tags=["Async Execution"])
...
@app.get("/api/v1/eagle-agents/agents", tags=["System"])
...
@app.get("/api/v1/eagle-agents/health", tags=["System"])
...
if __name__ == "__main__":
    ...
    # http://127.0.0.1:8003/api/v1/eagle-agents/docs
